...
class ChatApi {
  ...
  Future<Response<ConversationResponseDTO>> chatControllerCreateConversation({ 
    required CreateConversationRequestDTO createConversationRequestDTO,
    ...
    final _path = r'/app/chat/create-conversation';
    ...
    try {
      const _type = FullType(CreateConversationRequestDTO);
      _bodyData = _serializers.serialize(createConversationRequestDTO, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ConversationResponseDTO>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ConversationResponseDTO>>> chatControllerGetConversations({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/app/chat/get-conversations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<BuiltList<ConversationResponseDTO>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ConversationResponseDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConversationResponseDTO>> chatControllerGetMessages({ 
    required GetMessagesDTO getMessagesDTO,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/app/chat/get-messages';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GetMessagesDTO);
      _bodyData = _serializers.serialize(getMessagesDTO, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NumberOfUnreadMessagesResponseDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NumberOfUnreadMessagesResponseDTO>> chatControllerGetNumberOfUnreadMessages({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/app/chat/get-number-of-unread-messages';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    NumberOfUnreadMessagesResponseDTO? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(NumberOfUnreadMessagesResponseDTO),
      ) as NumberOfUnreadMessagesResponseDTO;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> chatControllerMarkConversationAsRead({ 
    required MarkConversationAsReadDTO markConversationAsReadDTO,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/app/chat/mark-conversation-as-read';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(MarkConversationAsReadDTO);
      _bodyData = _serializers.serialize(markConversationAsReadDTO, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> chatControllerMarkMessageAsRead({ 
    required MarkMessageAsReadDTO markMessageAsReadDTO,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/app/chat/mark-message-as-read';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(MarkMessageAsReadDTO);
      _bodyData = _serializers.serialize(markMessageAsReadDTO, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MessageResponseDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageResponseDTO>> chatControllerSendMessage({ 
    ...
    final _path = r'/app/chat/send-message';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateMessageDTO);
      _bodyData = _serializers.serialize(createMessageDTO, specifiedType: _type);
    ...
    return Response<MessageResponseDTO>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ConversationResponseDTO>> chatControllerSetConversationTitle({ 
    ...
    final _path = r'/app/chat/set-conversation-title';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
