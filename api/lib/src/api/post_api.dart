...
class PostApi {
  ...
  Future<Response<ReplyResponseDTO>> postControllerCreateReply({ 
    ...
    try {
      const _type = FullType(CreateReplyDTO);
  ...
  Future<Response<void>> postControllerDeleteComment({ 
    ...
    try {
      const _type = FullType(DeleteCommentDTO);
  ...
  Future<Response<void>> postControllerDeletePost({ 
    ...
    try {
      const _type = FullType(DeletePostDTO);
  ...
  Future<Response<void>> postControllerDeleteReply({ 
    ...
    try {
      const _type = FullType(DeleteReplyDTO);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<PostResponseDTO>>> postControllerGetLikedPosts({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postControllerLikeComment({ 
    required num commentId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/app/post/comment/{commentId}/like'.replaceAll('{' r'commentId' '}', encodeQueryParameter(_serializers, commentId, const FullType(num)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postControllerLikePost({ 
    required num postId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/app/post/{postId}/like'.replaceAll('{' r'postId' '}', encodeQueryParameter(_serializers, postId, const FullType(num)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postControllerLikeReply({ 
    required num replyId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/app/post/reply/{replyId}/like'.replaceAll('{' r'replyId' '}', encodeQueryParameter(_serializers, replyId, const FullType(num)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<CommentResponseDTO>> postControllerUpdateComment({ 
    ...
    try {
      const _type = FullType(UpdateCommentDTO);
  ...
  Future<Response<ReplyResponseDTO>> postControllerUpdateReply({ 
    ...
    try {
      const _type = FullType(UpdateReplyDTO);
