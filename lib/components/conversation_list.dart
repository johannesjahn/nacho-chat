...
class ConversationList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<List<ConversationResponseDTO>>(
      ...
      builder:
          (context, value, widget) => ListView.builder(
            ...
            itemBuilder: ((context, index) {
              return Card(
                child: InkWell(
                  ...
                  child: Builder(
                    builder: (context) {
                      final nonSelfParticipants =
                          value[index].participants
                              .where(
                                (participant) =>
                                    participant.id !=
                                    AppService.instance.userId,
                              )
                              .toList();
                      ...
                      if (lastMessage?.author.id !=
                          AppService.instance.userId) {
                        if (!(lastMessage?.readBy.any(
                              (p) => p.id == AppService.instance.userId,
                            ) ??
                            true)) {
                          isUnread = true;
                        }
